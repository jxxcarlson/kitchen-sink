    ...
    Element.column
        ...
        , Element.column
            ...
            [ Element.Input.text
                ...
                { onChange = Types.ReceivedSigninCode
...
rateLimited : SigninForm -> SigninForm
...
invalidCode : Int -> SigninForm -> SigninForm
...
enterEmailView model =
    Element.column
        ...
        , Element.row
            ...
            , MyElement.primaryButton submitEmailButtonId Types.SubmitEmailForSignIn "Sign in"
            ]
